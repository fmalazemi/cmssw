...
process.controller = cms.EDProducer("MPISource", service=cms.untracked.string("mpi_server"))

# run the producer on the cpu
#process.sender= cms.EDProducer('MPISender', controller=cms.InputTag("source"))
...
process.process_path = cms.Path(process.controller) #porocess.sender, process.producer_task)
