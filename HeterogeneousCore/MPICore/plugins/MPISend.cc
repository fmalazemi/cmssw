...
//
MPISend::MPISend(const edm::ParameterSet& iConfig): communicatorToken_{consumes(iConfig.getParameter<edm::InputTag>("communicator"))}, tagIDToken_{consumes(iConfig.getParameter<edm::InputTag>("tagID"))}, intToken_{consumes(iConfig.getParameter<edm::InputTag>("intData"))}, vectorToken_{consumes(iConfig.getParameter<edm::InputTag>("vectorData"))}, userTagID_{iConfig.getUntrackedParameter<int>("userTagID")}{
