...
//
DataValidator::DataValidator(const edm::ParameterSet& iConfig):originalIntToken_{consumes(iConfig.getParameter<edm::InputTag>("originalInt"))}, receivedIntToken_{consumes(iConfig.getParameter<edm::InputTag>("receivedInt"))}, originalVectorToken_{consumes(iConfig.getParameter<edm::InputTag>("originalVector"))}, receivedVectorToken_{consumes(iConfig.getParameter<edm::InputTag>("receivedVector"))} {
