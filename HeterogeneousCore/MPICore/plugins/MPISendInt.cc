...
//
MPISendInt::MPISendInt(const edm::ParameterSet& iConfig): communicatorToken_{consumes(iConfig.getParameter<edm::InputTag>("communicator"))}, tagIDToken_{consumes(iConfig.getParameter<edm::InputTag>("tagID"))}, intToken_{consumes(iConfig.getParameter<edm::InputTag>("intData"))},  userTagID_{iConfig.getUntrackedParameter<int>("userTagID")}{
