...
// Class:      MPISource
//
/**\class MPISource MPISource.cc HeterogeneousCore/MPICore/plugins/MPISource.cc
...
//         Created:  Tue, 28 May 2024 11:14:30 GMT
//
//
...
//
MPISource::MPISource(const edm::ParameterSet& iConfig, MPICommHandler const* hanlder):token_{produces()},tagToken_{produces()} {
