...
//
processData::processData(const edm::ParameterSet& iConfig): recvIntToken_{consumes(iConfig.getParameter<edm::InputTag>("recvIntData"))}, processedIntToken_{produces()},  recvVectorToken_{consumes(iConfig.getParameter<edm::InputTag>("recvVectorData"))}, processedVectorToken_{produces()}{
